...
int main() {
  ...
  v[1].s[0] = 0; v[1].s[1] = 1; 
  v[1].s[2] = 0; v[1].s[3] = 1;
  v[1].weight = "0.5"; v[1].priority = 2; 
  v[2].s[0] = 1; v[2].s[1] = 0; 
  v[2].s[2] = 1; v[2].s[3] = 0; 
  v[2].weight = "0.5"; v[2].priority = 2;
  v[3].s[0] = 0; v[3].s[1] = 1; 
  v[3].s[2] = 1; v[3].s[3] = 0;
  v[3].weight = "0.5"; v[3].priority = 1;
  v[4].s[0] = 1; v[4].s[1] = 0; 
  v[4].s[2] = 0; v[4].s[3] = 1;
  v[4].weight = "0.5"; v[4].priority = 1;
  v[5].s[0] = 1; v[5].s[1] = 1; 
  v[5].s[2] = 1; v[5].s[3] = 1;
  v[5].weight = "0.0"; v[5].priority = 3;
  v[6].s[0] = 0; v[6].s[1] = 0; 
  v[6].s[2] = 0; v[6].s[3] = 0;
  v[6].weight = "0.0"; v[6].priority = 4;
