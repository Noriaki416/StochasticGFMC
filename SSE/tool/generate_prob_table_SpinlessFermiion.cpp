...
int main() {
  ...
  v[1].s[0] = 0; v[1].s[1] = 1; 
  v[1].s[2] = 0; v[1].s[3] = 1;
  v[1].weight = "p.C+0.5*(p.v+p.h)"; v[1].priority = 2; 
  v[2].s[0] = 1; v[2].s[1] = 0; 
  v[2].s[2] = 1; v[2].s[3] = 0; 
  v[2].weight = "p.C+0.5*(p.v+p.h)"; v[2].priority = 2;
  v[3].s[0] = 0; v[3].s[1] = 1; 
  v[3].s[2] = 1; v[3].s[3] = 0;
  v[3].weight = "p.t"; v[3].priority = 1;
  v[4].s[0] = 1; v[4].s[1] = 0; 
  v[4].s[2] = 0; v[4].s[3] = 1;
  v[4].weight = "p.t"; v[4].priority = 1;
  v[5].s[0] = 1; v[5].s[1] = 1; 
  v[5].s[2] = 1; v[5].s[3] = 1;
  v[5].weight = "p.C"; v[5].priority = 3;
  v[6].s[0] = 0; v[6].s[1] = 0; 
  v[6].s[2] = 0; v[6].s[3] = 0;
  v[6].weight = "p.C+p.h"; v[6].priority = 4;
  ...
  */
  ...
  ofstream ofs;
  ofs.open("prob_table_SpinlessFermion.cpp");  
