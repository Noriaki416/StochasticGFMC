  for (int i=0; i<p.nsite; i++) {
    weight[0][i] = 0.0;
    weight[1][i] = p.C[i]+0.5*(p.v[i]+p.h[i]);
    weight[2][i] = p.C[i]+0.5*(p.v[i]+p.h[ir[i]]);
    weight[3][i] = 0.0;
    weight[4][i] = 0.0;
    weight[5][i] = p.C[i];
    weight[6][i] = p.C[i]+0.5*(p.h[i]+p.h[ir[i]]);
  }
  // vkind: 1 inleg: 0 outleg: 0 vkind_after_flipp: 1
    // 0 1 -> 0 1
  // 0 1 -> 0 1  weight: p.C[i]+0.5*(p.v[i]+p.h[i])
  // vkind: 1 inleg: 0 outleg: 1 vkind_after_flipp: 4
    // 0 1 -> 1 0
  // 0 1 -> 0 1  weight: p.t[i]
  // vkind: 1 inleg: 0 outleg: 2 vkind_after_flipp: 5
    // 0 1 -> 1 1
  // 0 1 -> 1 1  weight: p.C[i]
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[1][0][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]);
    prob2[1][0][i] = prob1[1][0][i] + (p.C[i]+0.5*(p.v[i]+p.h[i]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]);
  }
  ...
  // vkind: 1 inleg: 1 outleg: 3 vkind_after_flipp: 6
    // 0 1 -> 0 0
  // 0 1 -> 0 0  weight: p.C[i]+0.5*(p.h[i]+p.h[ir[i]])
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[1][1][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
    prob2[1][1][i] = prob1[1][1][i] + (p.C[i]+0.5*(p.v[i]+p.h[i]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
  }
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[1][2][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]);
    prob2[1][2][i] = prob1[1][2][i] + (p.C[i]+0.5*(p.v[i]+p.h[i]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]);
  }
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[1][3][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
    prob2[1][3][i] = prob1[1][3][i] + (p.C[i]+0.5*(p.v[i]+p.h[i]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
  }
  // vkind: 2 inleg: 0 outleg: 0 vkind_after_flipp: 2
    // 1 0 -> 1 0
  // 1 0 -> 1 0  weight: p.C[i]+0.5*(p.v[i]+p.h[ir[i]])
  // vkind: 2 inleg: 0 outleg: 1 vkind_after_flipp: 3
    // 1 0 -> 0 1
  // 1 0 -> 1 0  weight: p.t[i]
  // vkind: 2 inleg: 0 outleg: 2 vkind_after_flipp: 6
    // 1 0 -> 0 0
  // 1 0 -> 0 0  weight: p.C[i]+0.5*(p.h[i]+p.h[ir[i]])
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[2][0][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
    prob2[2][0][i] = prob1[2][0][i] + (p.C[i]+0.5*(p.v[i]+p.h[ir[i]]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
  }
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[2][1][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]);
    prob2[2][1][i] = prob1[2][1][i] + (p.C[i]+0.5*(p.v[i]+p.h[ir[i]]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]);
  }
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[2][2][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
    prob2[2][2][i] = prob1[2][2][i] + (p.C[i]+0.5*(p.v[i]+p.h[ir[i]]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
  }
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[2][3][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]);
    prob2[2][3][i] = prob1[2][3][i] + (p.C[i]+0.5*(p.v[i]+p.h[ir[i]]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]);
  }
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[3][0][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]);
    prob2[3][0][i] = prob1[3][0][i] + (p.C[i]+0.5*(p.v[i]+p.h[ir[i]]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]);
  }
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[3][1][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
    prob2[3][1][i] = prob1[3][1][i] + (p.C[i]+0.5*(p.v[i]+p.h[ir[i]]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
  }
  ...
  // vkind: 3 inleg: 2 outleg: 3 vkind_after_flipp: 1
    // 0 1 -> 0 1
  // 1 0 -> 0 1  weight: p.C[i]+0.5*(p.v[i]+p.h[i])
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[3][2][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
    prob2[3][2][i] = prob1[3][2][i] + (p.C[i]+0.5*(p.v[i]+p.h[i]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
  }
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[3][3][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]);
    prob2[3][3][i] = prob1[3][3][i] + (p.C[i]+0.5*(p.v[i]+p.h[i]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]);
  }
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[4][0][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
    prob2[4][0][i] = prob1[4][0][i] + (p.C[i]+0.5*(p.v[i]+p.h[i]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
  }
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[4][1][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]);
    prob2[4][1][i] = prob1[4][1][i] + (p.C[i]+0.5*(p.v[i]+p.h[i]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]);
  }
  ...
  // vkind: 4 inleg: 2 outleg: 3 vkind_after_flipp: 2
    // 1 0 -> 1 0
  // 0 1 -> 1 0  weight: p.C[i]+0.5*(p.v[i]+p.h[ir[i]])
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[4][2][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]);
    prob2[4][2][i] = prob1[4][2][i] + (p.C[i]+0.5*(p.v[i]+p.h[ir[i]]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]);
  }
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[4][3][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
    prob2[4][3][i] = prob1[4][3][i] + (p.C[i]+0.5*(p.v[i]+p.h[ir[i]]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
  }
  // vkind: 5 inleg: 0 outleg: 0 vkind_after_flipp: 5
    // 1 1 -> 1 1
  // 1 1 -> 1 1  weight: p.C[i]
  // vkind: 5 inleg: 0 outleg: 1 vkind_after_flipp: 0
    // 1 1 -> 0 0
  // 1 1 -> 1 1  weight: 0.0
  // vkind: 5 inleg: 0 outleg: 2 vkind_after_flipp: 1
    // 1 1 -> 0 1
  // 1 1 -> 0 1  weight: p.C[i]+0.5*(p.v[i]+p.h[i])
  // vkind: 5 inleg: 0 outleg: 3 vkind_after_flipp: 3
    // 1 1 -> 0 1
  // 1 1 -> 1 0  weight: p.t[i]
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[5][0][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]);
    prob2[5][0][i] = prob1[5][0][i] + (p.C[i]+0.5*(p.v[i]+p.h[i]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]);
  }
  ...
  // vkind: 5 inleg: 1 outleg: 2 vkind_after_flipp: 4
    // 1 1 -> 1 0
  // 1 1 -> 0 1  weight: p.t[i]
  // vkind: 5 inleg: 1 outleg: 3 vkind_after_flipp: 2
    // 1 1 -> 1 0
  // 1 1 -> 1 0  weight: p.C[i]+0.5*(p.v[i]+p.h[ir[i]])
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[5][1][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]);
    prob2[5][1][i] = prob1[5][1][i] + (p.C[i]+0.5*(p.v[i]+p.h[ir[i]]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]);
  }
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[5][2][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]);
    prob2[5][2][i] = prob1[5][2][i] + (p.C[i]+0.5*(p.v[i]+p.h[i]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]);
  }
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[5][3][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]);
    prob2[5][3][i] = prob1[5][3][i] + (p.C[i]+0.5*(p.v[i]+p.h[ir[i]]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]);
  }
  // vkind: 6 inleg: 0 outleg: 0 vkind_after_flipp: 6
    // 0 0 -> 0 0
  // 0 0 -> 0 0  weight: p.C[i]+0.5*(p.h[i]+p.h[ir[i]])
  // vkind: 6 inleg: 0 outleg: 1 vkind_after_flipp: 0
    // 0 0 -> 1 1
  // 0 0 -> 0 0  weight: 0.0
  // vkind: 6 inleg: 0 outleg: 2 vkind_after_flipp: 2
    // 0 0 -> 1 0
  // 0 0 -> 1 0  weight: p.C[i]+0.5*(p.v[i]+p.h[ir[i]])
  // vkind: 6 inleg: 0 outleg: 3 vkind_after_flipp: 4
    // 0 0 -> 1 0
  // 0 0 -> 0 1  weight: p.t[i]
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[6][0][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
    prob2[6][0][i] = prob1[6][0][i] + (p.C[i]+0.5*(p.v[i]+p.h[ir[i]]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
  }
  ...
  // vkind: 6 inleg: 1 outleg: 2 vkind_after_flipp: 3
    // 0 0 -> 0 1
  // 0 0 -> 1 0  weight: p.t[i]
  // vkind: 6 inleg: 1 outleg: 3 vkind_after_flipp: 1
    // 0 0 -> 0 1
  // 0 0 -> 0 1  weight: p.C[i]+0.5*(p.v[i]+p.h[i])
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[6][1][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
    prob2[6][1][i] = prob1[6][1][i] + (p.C[i]+0.5*(p.v[i]+p.h[i]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
  }
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[6][2][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
    prob2[6][2][i] = prob1[6][2][i] + (p.C[i]+0.5*(p.v[i]+p.h[ir[i]]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[ir[i]])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
  }
  ...
  for (int i=0; i<p.nsite; i++) {
    prob1[6][3][i] = (p.t[i])/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
    prob2[6][3][i] = prob1[6][3][i] + (p.C[i]+0.5*(p.v[i]+p.h[i]))/(p.t[i]+p.C[i]+0.5*(p.v[i]+p.h[i])+p.C[i]+0.5*(p.h[i]+p.h[ir[i]]));
  }
